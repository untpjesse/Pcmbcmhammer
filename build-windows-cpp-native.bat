...
echo [1/7] Checking for Visual Studio Build Tools...
set "VS_FOUND=0"
...
echo.
echo [4/7] Updating node-gyp build tools...
call npm install -g node-gyp
if %errorlevel% neq 0 (
    echo [WARNING] Failed to update node-gyp globally. Continuing anyway...
)

echo.
echo [5/7] Rebuilding C++ Native Modules for Electron...
...
echo.
echo [7/7] Packaging Windows Executable...
